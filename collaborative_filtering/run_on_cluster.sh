...
run_epochs() {
    ...
    scp "${REMOTE_USER}@${REMOTE_HOST}:~/collaborative_filtering/models/collaborative_filtering_${epochs}_epochs.keras" "$LOCAL_DIR/models/" || echo "Failed to download model!"
}
